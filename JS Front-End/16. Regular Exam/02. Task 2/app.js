...
function solve() {
  ...
  function createTaskHandler(event) {
    ...
    currentTasks.push({
      taskSelectorId: taskSelectorId.value,
      title: title.value,
  ...
  function internalDeleteTaskHandler() {
    ...
    // console.log(id);
    taskToEdit = currentTasks.find((t) => t.taskSelectorId === id);
  ...
  function deleteTaskHandler() {
    id = taskToEdit.taskSelectorId;
    // console.log(id);
    const taskToDelete = document.getElementById(`${id}`);

    const stateElementToDeleteIndex = currentTasks.findIndex(
      (t) => t.taskSelectorId === id
    );
    currentTasks.splice(stateElementToDeleteIndex, 1);
    // console.log(currentTasks);
