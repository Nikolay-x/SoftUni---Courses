...
sand_plants_heater_pump_percent = float(input())

aquarium_volume_cm3 = aquarium_length_cm * aquarium_width_cm * aquarium_height_cm
aquarium_volume_liters = aquarium_volume_cm3 / 1000
needed_water_liters = aquarium_volume_liters * (1 - sand_plants_heater_pump_percent / 100)
