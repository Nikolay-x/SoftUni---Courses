...
# oChanges the name of the task and returns the new name.
# oIf the new name is the same as the current name, returns "Name cannot be the same."
# -change_due_date(new_date: str)
# oChanges the due date of the task and returns the new date.
# oIf the new date is the same as the current date, returns "Date cannot be the same."
# -add_comment(comment: str)
# oAdds a comment to the task.
# -edit_comment(comment_number: int, new_comment: str)
# oThe comment number value represents the index of the comment we want to edit. The method should change the comment and return all the comments, separated by comma and space (", ")
# oIf the comment number is out of range, returns "Cannot find comment."
# -details()
# oReturns the task's details in this format:
...
# oAdds a new task to the collection and returns "Task {task details} is added to the section"
# oIf the task is already in the collection, returns "Task is already in the section {section_name}"
# -complete_task(task_name: str)
# oChanges the task to completed (True) and returns "Completed task {task_name}"
# oIf the task is not found, returns "Could not find task with the name {task_name}"
# -clean_section()
# oRemoves all the completed tasks and returns "Cleared {amount of removed tasks} tasks."
# -view_section()
# oReturns information about the section and its tasks in this format:
