...
# oIf you have enough budget and capacity add the animal (instance of Lion/Tiger/Cheetah) to the animals' list, reduce the budget, and return "{name} the {type of animal (Lion/Tiger/Cheetah)} added to the zoo"
# oIf you have the capacity, but no budget, return "Not enough budget"
# oIn any other case, you do not have space, and you should return "Not enough space for animal"
# hire_worker(worker)
# oIf you have not exceeded the capacity of workers in the zoo for the worker (instance of Keeper/Caretaker/Vet), add him to the workers and return "{name} the {type(Keeper/Vet/Caretaker)} hired successfully"
# oOtherwise, return "Not enough space for worker"
# fire_worker(worker_name)
# oIf there is a worker with that name in the workers' list, remove him and return "{worker_name} fired successfully"
# oOtherwise, return "There is no {worker_name} in the zoo"
# pay_workers()
# oIf you have enough budget to pay the workers (sum their salaries) pay them and return "You payed your workers. They are happy. Budget left: {left_budget}"
# oOtherwise, return "You have no budget to pay your workers. They are unhappy"
# tend_animals()
# oIf you have enough budget to take care of the animals, reduce the budget and return "You tended all the animals. They are happy. Budget left: {left_budget}"
# oOtherwise, return "You have no budget to tend the animals. They are unhappy."
# profit(amount)
# oIncrease the budget with the given amount of profit
# animals_status()
# oReturns the following string (Hint: use the __repr__ methods of the animals to print them on the console):
...
# {cheetahN}"
# workers_status()
# oReturns the following string (Hint: use the __repr__ methods of the workers to print them on the console):
