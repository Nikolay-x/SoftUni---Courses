...
# oAdd a new topping to the dictionary
# oIf there is no space left for a new topping, raise a ValueError: "Not enough space for another topping"
# oIf the topping is already in the dictionary, increase the value of its weight.
