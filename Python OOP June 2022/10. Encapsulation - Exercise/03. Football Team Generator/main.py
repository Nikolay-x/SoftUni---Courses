...
# oIf the player is already in the team, return "Player {name} has already joined"
# oOtherwise, add the player to the team and return "Player {name} joined team {team_name}"
