...
# Submit your solutions in the SoftUni judge system at https://judge.softuni.org/Contests/Practice/Index/3431#0
...
# username: str
# oA string that represents the username of the user
# oIf the name is an empty string, raise a ValueError with the message "Invalid username!"
# age: int
# oAn integer that represents the age of the user
# oIf the value of age is under 6, raise a ValueError with the message "Users under the age of 6 are not allowed!"
# movies_liked: list
# oAn empty list that will contain all movies (objects) liked by the user
# movies_owned: list
# oAn empty list that will contain all movies (objects) owned by the user
# Methods
...
# The class should have the following attributes:
# title: str
# oA string that represents the title of the movie
# oIf the title is an empty string, raise a ValueError with the message "The title cannot be empty string!"
# year: int
# oAn integer that represents the year when the movie was released
# oIf the year is under 1888, raise ValueError with the message "Movies weren't made before 1888!"
# owner: User
# oA user object that represents the one who made the movie
# oIf the owner is NOT an object of type User, raise a ValueError with the message "The owner must be an object of type User!"
# age_restriction: int
# oThe movie is unsuitable for people under the given age. The age restriction value depends on the movie genre.
# likes: int
# oIt represents the number of likes of the movie
# oIt should be set to 0 by default
# Methods
...
# oAn empty list that will contain all the movies (objects)
# users_collection: list
# oAn empty list that will contain all the users (objects)
# Methods
# __init__()
# In the __init__ method all the needed attributes must be set.
