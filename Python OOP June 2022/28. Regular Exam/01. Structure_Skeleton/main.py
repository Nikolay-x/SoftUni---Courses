...
# name: str
# oA string that represents the name of the jockey
# oIf the name is an empty string or contains only white spaces, raise a ValueError with the message: "Name should contain at least one character!"
#
# age: int
# oAn integer that represents the age of the jockey
# oThe jockey must be at least 18 years old; if not - raise a ValueError with the message "Jockeys must be at least 18 to participate in the race!"
# horse: Horse
# oAn instance of a Horse (child) class representing the horse taken by the jockey. When a jockey is created in the app, he/she has NOT been given a horse yet.
# oThe value should be set to None.
# oKeep in mind that one jockey can ride only one horse.
# Methods
...
# The class should have the following attributes:
# name: str
# oA string that represents the name of the horse.
# oIf the name is less than 4 symbols, raise a ValueError with the message "Horse name {value} is less than 4 symbols!"
# speed: int
# oAn integer representing the speed that the horse can achieve.
# oKeep in mind that each horse breed has a different maximum speed, which cannot be exceeded. If the given horse speed exceeds the maximum, raise a ValueError with the message: "Horse speed is too high!"
# is_taken: bool
# oA Boolean that represents the state of the horse - taken or not. When a horse is created in the app, it is free to be given to any jockey.
# oIt should be set to False.
# oKeep in mind that one horse can have only one rider.
# Methods
...
# The class should have the following attributes:
# race_type: str
# oThe valid types are "Winter", "Spring", "Autumn", or "Summer"
# oIf the race type is NOT one of the above-mentioned, raise a ValueError with the message: "Race type does not exist!"
# jockeys: list
# oAn empty list that will store all the jockeys (objects) who will take part in the race.
# Methods
...
# The class should have the following attributes:
# horses: list
# oAn empty list that will contain all the horses (objects).
# jockeys: list
# oAn empty list that will contain all the jockeys (objects).
# horse_races: list
# oAn empty list that will contain all the horse races (objects).
# Methods
# __init__()
# In the __init__ method all the needed attributes must be set.
