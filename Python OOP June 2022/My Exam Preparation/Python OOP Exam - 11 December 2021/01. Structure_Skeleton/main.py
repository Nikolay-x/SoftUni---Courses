...
# model: str
# oIf the model is less than 4 symbols, raise a ValueError with the message "Model {model} is less than 4 symbols!"
# speed_limit: int
# oEvery type of car has a different range of speed limit. If it is not in the valid range, raise a ValueError with the message "Invalid speed limit! Must be between {min_speed_limit} and {max_speed_limit}!"
# oAll speed limit values will be unique. You do NOT need to check it explicitly.
# is_taken: bool
# oThe default value is False.
# oOne car can be driven by ONLY one driver.
# Methods
...
# The class should have the following attributes:
# name: str
# oIf the name is an empty string or contains only white spaces (one or many), raise a ValueError with the message "Name should contain at least one character!"
# car: Car
# oThe default value is None.
# oOne driver drives ONLY one car.
# number_of_wins: int
# oThe default value is 0.
# oWhen the driver wins a race, the number of wins should be increased!
# Methods
# __init__(name: str)
# In the __init__ method all the needed attributes must be set.
# 5.Class Race
...
# drivers: list
# oAn empty list that will contain all the drivers (objects) participating in the race
# Methods
# __init__(name: str)
# In the __init__ method all the needed attributes must be set.
# 6.Class Controller
...
# The class should have the following attributes:
# cars: list
# oAn empty list that will contain all cars (objects)
# drivers: list
# oAn empty list that will contain all drivers (objects)
# races: list
# oAn empty list that will contain all races (objects)
# Methods
# __init__()
# In the __init__ method all the needed attributes must be set.
