...
# oIf the name is an empty string or whitespace, raise a ValueError with the message: "Name cannot be empty string or white space!"
...
# oIf the price is less than or equal to 0, raise a ValueError with the message: "Price cannot be less than or equal to zero!"
# Methods
...
# oIf the portion is less than or equal to 0, raise a ValueError with the message "Portion cannot be less than or equal to zero!"
# price: float - passed upon initialization.
# brand: string - passed upon initialization.
# oIf the brand name is an empty string or whitespace, raise a ValueError with the message "Brand cannot be empty string or white space!"
#
# Methods
...
# oIf it is less than or equal to zero, raise a ValueError with the message "Capacity has to be greater than 0!"
...
# oIf the name is an empty string or whitespace, raise a ValueError with a message "Name cannot be empty string or white space!"
...
bakery = Bakery("B1")
print(bakery.add_food("Bread", "White bread", 3.567))
# print(bakery.add_food("Bread", "White bread", 3.5))
print(bakery.add_food("Bread", "Grain bread", 1.5))
print(bakery.add_food("Cake", "Apple cake", 5.512))
print()

print(bakery.add_drink("Tea", "Lemon tea", 150, "BT"))
# print(bakery.add_drink("Tea", "Lemon tea", 150, "BT"))
print(bakery.add_drink("Tea", "Fruit tea", 150, "GY"))
print(bakery.add_drink("Water", "Mineral water", 300, "KP"))
print()

# print(bakery.add_table("InsideTable", 52, 4))
print(bakery.add_table("InsideTable", 10, 4))
print(bakery.add_table("InsideTable", 20, 4))
print(bakery.add_table("InsideTable", 30, 4))
# print(bakery.add_table("OutsideTable", 50, 4))
print(bakery.add_table("OutsideTable", 60, 6))
print(bakery.add_table("OutsideTable", 70, 6))
print(bakery.add_table("OutsideTable", 80, 6))
# print(bakery.add_table("OutsideTable", 80, 4))
print()
...
print(bakery.order_food(10, "not in menu1", "not in menu2", "White bread", "Apple cake"))
print()
print(bakery.order_drink(10, "not in menu1", "not in menu2", "Lemon tea", "Mineral water"))
print()

print(bakery.order_food(60, "not in menu1", "not in menu2", "White bread", "Apple cake"))
print()
print(bakery.order_drink(60, "not in menu1", "not in menu2", "Lemon tea", "Mineral water"))
print()

print(bakery.leave_table(10))
print()

print(bakery.leave_table(60))
print()
