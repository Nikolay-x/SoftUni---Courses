...
# name: str
# oIf the name is an empty string or whitespace, raise a ValueError with the message: "Astronaut name cannot be empty string or whitespace!"
# оxygen: int
# oThe oxygen of an astronaut in units
# backpack: an empty list
# oIn the backpack, each astronaut will collect items while on a mission
# Methods
...
# The class should have the following attributes:
# name: str
# oIf the name is an empty string or whitespace, raise a ValueError with the message: "Planet name cannot be empty string or whitespace!"
...
# oYou should pick up to 5 astronauts with the highest amount of oxygen among the ones with oxygen above 30 units.
# oIf you don't have any suitable astronauts, raise an Exception with the following message: "You need at least one astronaut to explore the planet!"
# The astronauts start going out in open space one by one, sorted in descending order by the amount of oxygen they have:
# oAn astronaut lands on a planet and starts collecting its items one by one starting from the last one in the collection. Each time he/she finds an item he/she takes a breath.
# oIf an astronaut runs out of oxygen, he/ she should return to the space station, and the next astronaut starts exploring.
# A mission is successful when all the items from the planet are collected:
# oIf it is successful, return the following message, with the name of the explored planet and the number of the astronauts that had gone out in open space: "Planet: {planet_name} was explored. {astronauts} astronauts participated in collecting items."
# oOtherwise, return: "Mission is not completed."
# report()
...
ss1 = SpaceStation()
print(ss1.add_astronaut("Biologist", "B1"))
print(ss1.add_astronaut("Biologist", "B1"))
print(ss1.add_astronaut("Biologist", "B2"))
# print(ss1.add_astronaut("Bioogist", "B2"))

print(ss1.add_astronaut("Geodesist", "G1"))
print(ss1.add_astronaut("Geodesist", "G2"))

print(ss1.add_astronaut("Meteorologist", "M1"))
print(ss1.add_astronaut("Meteorologist", "M2"))
print()

print(ss1.add_planet("P1", "item1, item2, item3, item4, item5, item6, item7, "
                           "item8, item9, item10, item11, item12, item13"))

print(ss1.add_planet("P2", "ite1, ite2, ite3, ite4, ite5, ite6, ite7, "
                           "ite8, ite9, ite10, ite11, ite12, ite13, ite14"))
print()

print(ss1.retire_astronaut("B1"))
# print(ss1.retire_astronaut("B2"))
# print(ss1.retire_astronaut("G2"))
# print(ss1.retire_astronaut("M1"))
# print(ss1.retire_astronaut("G1"))
print()

# ss1.recharge_oxygen()
print(ss1.send_on_mission("P1"))
print(ss1.send_on_mission("P2"))

# # print(ss1.retire_astronaut("G3"))
